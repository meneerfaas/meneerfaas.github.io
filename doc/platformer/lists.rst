...
Voor het programmeren van games heb je vaak niet genoeg aan deze vier datatypes. Veel games hebben namelijk te maken met verzamelingen van waarden. Bijvoorbeeld, een verzameling vijanden, een lijst van items in een inventory of een reeks levels.
